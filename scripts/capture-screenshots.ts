...
async function captureScreenshots() {
  ...
  await page1.screenshot({ path: "pr-screenshots/homepage-light.png", fullPage: true });
  await page1.close();
  ...
  await page2.screenshot({ path: "pr-screenshots/homepage-dark.png", fullPage: true });
  await page2.close();

  // 404 page
  const page3 = await context.newPage();
  await page3.goto(`${baseUrl}/this-page-does-not-exist`);
  await page3.screenshot({ path: "pr-screenshots/404.png", fullPage: true });
  await page3.close();
